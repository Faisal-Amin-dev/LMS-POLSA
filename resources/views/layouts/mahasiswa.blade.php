    ...
    <div class="flex h-screen w-full">
        ...
        <aside 
            ...
            <nav class="mt-4 flex-1 overflow-y-auto py-2 space-y-1 px-2">
                ...
                <a href="{{ route('mahasiswa.krs.index') }}" class="flex items-center py-2.5 px-3 rounded transition duration-200 hover:bg-slate-800 {{ request()->routeIs('mahasiswa.krs.*') ? 'bg-slate-700 text-white' : 'text-slate-400' }}">
                    <i class="fas fa-file-alt w-6 text-center"></i>
                    <span class="ml-3 font-medium">KRS Paket Smt</span>
                </a>
            </nav>
        </aside>
